...
from bt_api_bitbank import __version__
from bt_api_bitbank.registry_registration import register_bitbank
...
def register_plugin(
    ...
    register_bitbank(registry)

    return PluginInfo(
        name="bt_api_bitbank",
        version=__version__,
        core_requires=">=0.15,<1.0",
        supported_exchanges=("BITBANK___SPOT",),
